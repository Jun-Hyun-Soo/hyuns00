...
<link rel="stylesheet" href="/resources/css/cate/write.css"></link>
...
<form:form commandName="cateDto" method="post" action="/cate/writeOk">
	<spring:bind path="*">
    ...
    <table class="cssCateTable">
	    ...
	    <tr>
		    <th> 사용유무 :</th>
		    <td>
				<form:radiobutton path="useYn" value="Y" label="예" checked="checked" />
    ...
    <div class="cssCateButton">
	    <input type="image" id="imgBtnWrite" value="" onclick="imgBtnCateWrite_click(form); return false;" /> 
